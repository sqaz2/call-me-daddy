(()=>{
  const songAdditions=[
    ...
    {id:'survival-mode',title:'Survival Mode',artist:'Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Survival Mode',description:'A Celtic North remix that can read as a poker survival song or a love song. The double meaning is part of the idea.',audio:'/media/songs/2026/08/survival-mode/celtic-north-remix.mp3',cover:'/media/songs/2026/08/survival-mode/cover.jpg',kind:'Celtic North Remix',variants:[{id:'celtic-north-remix',label:'Celtic North Remix',audio:'/media/songs/2026/08/survival-mode/celtic-north-remix.mp3'}]},
