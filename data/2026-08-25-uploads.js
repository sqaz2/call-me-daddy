  ...
  const songAdditions=[
    {
      ...
      audio:'/media/songs/2026/08/where-the-teeth-are-kept/google-gemini.mp3',cover:'/media/songs/2026/08/where-the-teeth-are-kept/cover.jpg',kind:'Google Gemini · seductive fairytale',
    ...
    },
    {
      ...
      audio:'/media/songs/2026/08/one-million-dollars/dr-evil-satire.mp3',cover:'/media/songs/2026/08/one-million-dollars/cover.jpg',kind:'Satirical Dubstep',
    ...
    },
    {
      ...
      audio:'/media/songs/2026/08/where-the-bad-girls-at/concrete-heels-female.mp3',cover:'/media/songs/2026/08/where-the-bad-girls-at/cover.jpg',kind:'2 versions',
      variants:[
    ...
    {
      id:'the-loudest-one-in-my-head',title:'The Loudest One in My Head',artist:'MusicSubject',year:2026,month:8,date:'2026-08-25',project:'The Loudest One in My Head',description:'A self-questioning song about wondering whether you are difficult, whether you rub people the wrong way, and whether loneliness is evidence that the people you annoy simply do not care.',audio:'/media/songs/2026/08/the-loudest-one-in-my-head/remix.mp3',cover:'/media/songs/2026/08/the-loudest-one-in-my-head/cover.jpg',kind:'Remix',variants:[{id:'remix',label:'Remix',audio:'/media/songs/2026/08/the-loudest-one-in-my-head/remix.mp3'}]
    },
    {
      id:'mind-at-war',title:'Mind at War',artist:'Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Mind at War',description:'Melodic dubstep about overcoming madness, winning against the demons in your own head, and coming out of the fight still standing.',audio:'/media/songs/2026/08/mind-at-war/remix.mp3',cover:'/media/songs/2026/08/mind-at-war/cover.jpg',kind:'Melodic Dubstep Remix',variants:[{id:'melodic-dubstep-remix',label:'Melodic Dubstep Remix',audio:'/media/songs/2026/08/mind-at-war/remix.mp3'}]
    },
    {
      id:'ashes-in-eastwood',title:'Ashes in Eastwood',artist:'Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Ashes in Eastwood',description:'A deliberately trashy fictional satire: sleeping with your meth-fuelled wife’s sister, getting caught, and having the car burned. The joke was sparked by seeing a burned car in Eastview, Red Deer; it is not presented as the real story of that car.',audio:'/media/songs/2026/08/ashes-in-eastwood/marshmallows-over-the-wreckage.mp3',cover:'/media/songs/2026/08/ashes-in-eastwood/cover.jpg',kind:'Satire · Marshmallows Over the Wreckage',variants:[{id:'marshmallows-over-the-wreckage',label:'Marshmallows Over the Wreckage',audio:'/media/songs/2026/08/ashes-in-eastwood/marshmallows-over-the-wreckage.mp3'}]
    },
    {
      id:'shooting-star',title:'Shooting Star',artist:'MusicSubject',year:2019,project:'Old Files / New Tools',description:'A heartbreak song written in Nova Scotia in 2019, shortly before leaving and moving roughly 4,000 km to Edmonton, Alberta.',lineage:'Written in 2019 before the Nova Scotia-to-Edmonton move. Exact day not recorded.',audio:'/media/songs/2019/shooting-star/shooting-star.mp3',cover:'/media/songs/2019/shooting-star/cover.jpg',kind:'2019 heartbreak archive',variants:[{id:'2019-cut',label:'2019 cut',audio:'/media/songs/2019/shooting-star/shooting-star.mp3'}]
    },
    {id:'where-monsters-are',title:'Where Monsters Are',artist:'Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Where Monsters Are',description:'The DNB Folk Tale is the newest version of this song family. Earlier versions exist and will stay under the same identity when they are added.',audio:'/media/songs/2026/08/where-monsters-are/dnb-folk-tale.mp3',cover:'/media/songs/2026/08/where-monsters-are/cover.jpg',kind:'DNB Folk Tale · latest version',lineage:'Earlier versions exist; this is the newest uploaded version.',variants:[{id:'dnb-folk-tale',label:'DNB Folk Tale · latest version',audio:'/media/songs/2026/08/where-monsters-are/dnb-folk-tale.mp3'}]},
    {id:'hard-earned-light',title:'Hard-Earned Light',artist:'Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Hard-Earned Light',description:'A hardcore epic-dubstep keep-going song about fighting through darkness and surviving every night that tried to convince you that you were worthless. The light matters because you had to earn it.',audio:'/media/songs/2026/08/hard-earned-light/epic-dubstep-mix.mp3',cover:'/media/songs/2026/08/hard-earned-light/cover.jpg',kind:'Hardcore Epic Dubstep Mix',variants:[{id:'epic-dubstep-mix',label:'Hardcore Epic Dubstep Mix',audio:'/media/songs/2026/08/hard-earned-light/epic-dubstep-mix.mp3'}]},
    {id:'survival-mode',title:'Survival Mode',artist:'MusicSubject × Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Still Building',description:'A personal survival song about working, building, and trying to turn the van into a chapter instead of the ending.',audio:'/media/songs/2026/09/survival-mode/suno-v6-remix.mp3',cover:'/media/projects/2026/09/still-building/survival-mode-v6.jpg',experience:'/still-building/?song=survival-mode&version=suno-v6-remix',kind:'2 versions',variants:[{id:'suno-v6-remix',label:'Celtic North · Suno V6 Remix',audio:'/media/songs/2026/09/survival-mode/suno-v6-remix.mp3',cover:'/media/projects/2026/09/still-building/survival-mode-v6.jpg',duration:263.184,sunoUrl:'https://suno.com/s/giCKCpIlLlVmoqU7'},{id:'celtic-north-remix',label:'Earlier Celtic North Remix',audio:'/media/songs/2026/08/survival-mode/celtic-north-remix.mp3',cover:'/media/songs/2026/08/survival-mode/cover.jpg'}]},
    {id:'the-tune-of-magical-song',title:'The Tune of Magical Song',artist:'MusicSubject × Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Old Files / New Tools',description:'This song goes back to a recording made more than a decade ago. This upload is a remastered Deep Dark Dubstep Drop Mix, and other versions exist.',audio:'/media/songs/2026/08/the-tune-of-magical-song/deep-dark-dubstep-drop-remastered.mp3',cover:'/media/songs/2026/08/the-tune-of-magical-song/cover.jpg',kind:'Deep Dark Dubstep Drop Mix · Remastered',lineage:'Recorded more than a decade before this 2026 remaster; other versions exist.',variants:[{id:'deep-dark-dubstep-drop-remastered',label:'Deep Dark Dubstep Drop Mix · Remastered',audio:'/media/songs/2026/08/the-tune-of-magical-song/deep-dark-dubstep-drop-remastered.mp3'}]},
    {id:'side-chick-finder',title:'Side Chick Finder (Community Boyfriend 😂)',artist:'Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Side Chick Finder',description:'The community-boyfriend joke gets its own track.',audio:'/media/songs/2026/08/side-chick-finder/community-boyfriend.mp3',cover:'/media/songs/2026/08/side-chick-finder/cover.jpg',kind:'song'},
    {id:'one-brick',title:'One Brick',artist:'Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'One Brick',description:'One Brick rebuilt as a Barbershop Dubstep A Cappella mix.',audio:'/media/songs/2026/08/one-brick/barbershop-dubstep-acappella.mp3',cover:'/media/songs/2026/08/one-brick/cover.jpg',kind:'Barbershop Dubstep A Cappella Mix',variants:[{id:'barbershop-dubstep-acappella',label:'Barbershop Dubstep A Cappella Mix',audio:'/media/songs/2026/08/one-brick/barbershop-dubstep-acappella.mp3'}]}
  ];
