(()=>{
  const songAdditions=[
    ...
    {id:'survival-mode',title:'Survival Mode',artist:'MusicSubject × Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Still Building',description:'A personal survival song about working, building, and trying to turn the van into a chapter instead of the ending.',audio:'/media/songs/2026/09/survival-mode/suno-v6-remix.mp3',cover:'/media/songs/2026/08/survival-mode/cover.jpg',experience:'/still-building/?song=survival-mode&version=suno-v6-remix',kind:'2 versions',variants:[{id:'suno-v6-remix',label:'Celtic North · Suno V6 Remix',audio:'/media/songs/2026/09/survival-mode/suno-v6-remix.mp3',cover:'/media/songs/2026/08/survival-mode/cover.jpg',duration:263.184,sunoUrl:'https://suno.com/s/giCKCpIlLlVmoqU7'},{id:'celtic-north-remix',label:'Earlier Celtic North Remix',audio:'/media/songs/2026/08/survival-mode/celtic-north-remix.mp3',cover:'/media/songs/2026/08/survival-mode/cover.jpg'}]},
