(()=>{
  const songAdditions=[
    {
      id:'the-loudest-one-in-my-head',title:'The Loudest One in My Head',artist:'MusicSubject',year:2026,month:8,date:'2026-08-25',project:'The Loudest One in My Head',
      description:'A self-questioning song about wondering whether you are difficult, whether you rub people the wrong way, and whether loneliness is evidence that the people you annoy simply do not care.',
      audio:'/media/songs/2026/08/the-loudest-one-in-my-head/remix.mp3',cover:'',kind:'Remix',
      variants:[{id:'remix',label:'Remix',audio:'/media/songs/2026/08/the-loudest-one-in-my-head/remix.mp3'}]
    },
    {
      id:'mind-at-war',title:'Mind at War',artist:'Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Mind at War',
      description:'Melodic dubstep about overcoming madness, winning against the demons in your own head, and coming out of the fight still standing.',
      audio:'/media/songs/2026/08/mind-at-war/remix.mp3',cover:'',kind:'Melodic Dubstep Remix',
      variants:[{id:'melodic-dubstep-remix',label:'Melodic Dubstep Remix',audio:'/media/songs/2026/08/mind-at-war/remix.mp3'}]
    },
    {
      id:'ashes-in-eastwood',title:'Ashes in Eastwood',artist:'Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Ashes in Eastwood',
      description:'A deliberately trashy fictional satire: sleeping with your meth-fuelled wife’s sister, getting caught, and having the car burned. The joke was sparked by seeing a burned car in Eastview, Red Deer; it is not presented as the real story of that car.',
      audio:'/media/songs/2026/08/ashes-in-eastwood/marshmallows-over-the-wreckage.mp3',cover:'',kind:'Satire · Marshmallows Over the Wreckage',
      variants:[{id:'marshmallows-over-the-wreckage',label:'Marshmallows Over the Wreckage',audio:'/media/songs/2026/08/ashes-in-eastwood/marshmallows-over-the-wreckage.mp3'}]
    },
    {
      id:'shooting-star',title:'Shooting Star',artist:'MusicSubject',year:2019,project:'Old Files / New Tools',
      description:'A heartbreak song written in Nova Scotia in 2019, shortly before leaving and moving roughly 4,000 km to Edmonton, Alberta.',
      lineage:'Written in 2019 before the Nova Scotia-to-Edmonton move. Exact day not recorded.',
      audio:'/media/songs/2019/shooting-star/shooting-star.mp3',cover:'',kind:'2019 heartbreak archive',
      variants:[{id:'2019-cut',label:'2019 cut',audio:'/media/songs/2019/shooting-star/shooting-star.mp3'}]
    },
    {
    ...
    {
      id:'hard-earned-light',title:'Hard-Earned Light',artist:'Call Me Daddy',year:2026,month:8,date:'2026-08-25',project:'Hard-Earned Light',
      description:'A hardcore epic-dubstep keep-going song about fighting through darkness and surviving every night that tried to convince you that you were worthless. The light matters because you had to earn it.',
      audio:'/media/songs/2026/08/hard-earned-light/epic-dubstep-mix.mp3',cover:'',kind:'Hardcore Epic Dubstep Mix',variants:[{id:'epic-dubstep-mix',label:'Hardcore Epic Dubstep Mix',audio:'/media/songs/2026/08/hard-earned-light/epic-dubstep-mix.mp3'}]
    },
    {
  ...
  if(Array.isArray(window.CMD_SONGS)){
    ...
    if(numbness){if(!Array.isArray(numbness.variants))numbness.variants=[];if(!numbness.variants.some(version=>version.id==='barbershop-wobble-edit'))numbness.variants.push({id:'barbershop-wobble-edit',label:'Barbershop Wobble Edit',audio:'/media/collections/sad-music/2026/numbness-as-a-trap/barbershop-wobble.mp3'});numbness.kind=`${numbness.variants.length} versions`;}
  }
  ...
  if(Array.isArray(window.CMD_SAD_MUSIC)){
    ...
    if(numbness){if(!Array.isArray(numbness.versions))numbness.versions=[];if(!numbness.versions.some(version=>version.id==='barbershop-wobble-edit'))numbness.versions.push({id:'barbershop-wobble-edit',label:'Barbershop Wobble Edit',audio:'/media/collections/sad-music/2026/numbness-as-a-trap/barbershop-wobble.mp3',expectedPath:'/media/collections/sad-music/2026/numbness-as-a-trap/barbershop-wobble.mp3'});numbness.story='Three mixes survived, so all three stay with the same song.';}
  }
})();
