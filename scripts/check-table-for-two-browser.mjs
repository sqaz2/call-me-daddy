...
try{
  ...
  assert.ok(Math.abs(playing.duration-144.12)<.05);
  ...
  assert.equal(await frame.locator('#releaseSuno').getAttribute('href'),'https://suno.com/song/8d3d14bd-65fb-4b04-95ae-fc46ef1a039b');
  ...
  assert.equal(await frame.locator('#releaseSuno').getAttribute('href'),'https://suno.com/song/de2f1819-86af-48c8-8f2b-32e7cb559f9f');
  ...
  assert.ok(decodeURI(await deep.evaluate(()=>window.CMDUniversalPlayer.getMedia().src)).endsWith('/fuck everybody but you.mp3'));
